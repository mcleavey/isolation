...
from comparison_game_agent import (AlphaBetaSortingPlayer, AlphaBetaNonRandomPlayer)
...
#        Agent(AlphaBetaNonRandomPlayer(score_fn=diff_dist_score), "Diff_Dist"),
#        Agent(AlphaBetaNonRandomPlayer(score_fn=dist_diff_score), "Dist_Diff"),
#        Agent(AlphaBetaPlayer(score_fn=diff_late_game), "Diff Late Game"),       
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_sum), "Diff_dist_sum"),
#        Agent(AlphaBetaPlayer(score_fn=diff_sqdist_sum), "Diff_SqDist"),
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_half_sum), "DD_half"),
 #       Agent(AlphaBetaPlayer(score_fn=diff_dist_subt), "DD_subt"),
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_half_subt), "DD_half_subt"),
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_eq_subt), "DD_eq_subt"),
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_full_subt), "DD_full_subt"),
 #       Agent(AlphaBetaPlayer(score_fn=diff_dist_eq_subt), "DD_eq_sub"),
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_dbl_subt), "DD_dbl_sub"),
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_dbfive_subt), "DD_2.5_sub"),
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_trp_subt), "DD_3_sub"),
#        Agent(AlphaBetaPlayer(score_fn=adv_stages_score), "Adv stages")
#        Agent(AlphaBetaPlayer(score_fn=diff_dist_pteight_sum), "DD_pt_8")
#        Agent(AlphaBetaPlayer(score_fn=next_step_score), "Next_Step"),
#        Agent(AlphaBetaPlayer(score_fn=stages_score), "Stage")
#        Agent(AlphaBetaPlayer(score_fn=mod_stages_score), "Mod Stages")
           ]
